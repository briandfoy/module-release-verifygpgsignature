...
To read about L<Module::Release::VerifyGPGSignature>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Module/Release/VerifyGPGSignature.pm

If you have already installed the module, you can specify the module
name instead of the file location:

	% perldoc Module::Release::VerifyGPGSignature

You can read the documentation and inspect the meta data on
L<MetaCPAN|http://www.metacpan.org/module/Module::Release::VerifyGPGSignature>.
...
and install the dependencies:
	...
	% cpan Module::Release::VerifyGPGSignature
	% cpanm Module::Release::VerifyGPGSignature
...
=item *	L<https://github.com/briandfoy/module-release-verifygpgsignature>
...
=item *	L<https://github.com/briandfoy/module-release-verifygpgsignature/issues>
